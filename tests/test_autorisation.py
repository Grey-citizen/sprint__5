...
class TestAuthorisation:
    ...
    def test_login_in_acc_main_button(self, webdriver_fixture):
    ...
    def test_login_in_acc_personal_cabinet_button(self, webdriver_fixture):
        driver = webdriver_fixture
        driver.get("https://stellarburgers.nomoreparties.site/")
    ...
    def test_login_in_acc_registration_form_button(self, webdriver_fixture):
        driver = webdriver_fixture
    ...
    def test_login_in_acc_password_recovery_form_button(self, webdriver_fixture):
        driver = webdriver_fixture
